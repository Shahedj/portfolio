    ...
    
{
    ...
    img: "CyberAI.png",
    description: "Developed CyberBot, a full-stack AI-powered cyber risk and SOC incident analysis platform using React.js, FastAPI, Python, and GPT-4o-mini with real-time streaming via Server-Sent Events (SSE). Implemented secure authentication using OAuth2, JWT-based sessions, password hashing, and TOTP-based multi-factor authentication (MFA). Built AI safety controls including prompt Engineering to restrict the AI to ethical cybersecurity topics while refusing malicious or illegal request, and PII detection to block sensitive data (SSNs, credit cards, passwords). Designed an automated incident analysis engine generating risk severity scores, OWASP Top 10/CWE mappings, CVSS-based assessments, and remediation recommendations stored in SQLite. Developed a SOC-style dashboard for incident tracking, analytics, and PDF export of cybersecurity reports. <br>  <a href='https://www.linkedin.com/posts/shahad-jaber-2ab4a6249_cybersecurity-ai-openai-activity-7449471482755440642-_Bv8?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD15lCMB_tl29BpRH72l9Nro1raclqjWzjY' target='_blank'  style=\"color: #e73872; text-decoration: underline; font-weight: bold;\" rel=\"noopener noreferrer\">Part 1:Click here to view the demo.  <b>Part 2: Coming soon.</b></a>"
},
{
